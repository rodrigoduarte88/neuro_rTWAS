...
This yml file contains all exact software and library versions required to run focus/fusion.
...
<br>
`wget ________________` # awaiting DOI from FigShare. If you are at this page, you should already have access to a private link containing all code and rTWAS weights, which you can decompress and move on to the following steps.<br> 
